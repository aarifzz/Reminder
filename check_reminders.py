...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "dsatracker.settings")  # Replace `your_project` with your project name
django.setup()

from tracker.models import ProblemRevision  # Replace with your model and app
...
for prob in problems:
    ...
    if days_since == 1 and not prob.day_1:
        send_mail(
            ...
            ['badrinarayan.moola@gmail.com'],  # If user relation exists
        )
